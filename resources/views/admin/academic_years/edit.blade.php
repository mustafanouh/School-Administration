    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Update the details for the academic session: <span
                            class="text-indigo-600 font-bold">{{ $academicYear->name }}</span>
                    </p>
                </div>
            ...
            <div
                ...
                <form action="{{ route('academic_years.update', $academicYear) }}" method="POST" class="p-8 md:p-12">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name"
                                    value="{{ old('name', $academicYear->name) }}" placeholder="e.g. 2025-2026"
                        ...
                        <div
                            ...
                            <p class="mt-4 text-[10px] text-amber-600 dark:text-amber-400 font-bold italic">
                                * Note: Enabling this will automatically deactivate all other academic years.
                            </p>
                        </div>
                    </div>
            ...
            {{-- Info Footer --}}
            <div
                class="mt-8 p-6 bg-indigo-50 dark:bg-indigo-900/20 rounded-[2rem] border border-indigo-100 dark:border-indigo-800/50 flex items-start space-x-4 rtl:space-x-reverse">
                <div class="text-indigo-500 mt-1">
                    <i class="fas fa-info-circle"></i>
                </div>
                <p class="text-xs text-indigo-700 dark:text-indigo-300 leading-relaxed font-medium">
                    Updating the academic year name will affect all linked records including enrollments and marks.
                    However, the system's automated semesters (First, Second, Summer) will remain linked to this record.
                </p>
            </div>
        </div>
    </div>
