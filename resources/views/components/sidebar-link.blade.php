...
<div class="px-2 py-1">
    <a href="{{ $href }}" 
        ...
        {{ $active ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600' : 'text-gray-600 dark:text-white hover:bg-white dark:hover:bg-white/5 hover:-translate-y-1 hover:shadow-lg' }}"
    >
